...
if (gameState === "instruction") {
  ...
  textSize(50);
  text("------XXXXXXX------", window.width / 2 - 300, window.height / 2 - 300);
  text("ENJOY THE GAME!", window.width / 2 - 300, window.height / 2 - 200);
  text("Press Space To Shoot",window.width/2 - 300,window.height /2 - 100);
  text("Press The Up Arrow Key To Move",window.width/2 - 300,window.height /2 - 50);
  text("Press The Down Arrow Key To Move",window.width/2 - 300,window.height /2  + 75);
...
if(gameState == "lost"){
  ...
  text("Press F5 To Try Again",475,475);
